    ...
    <>
      ...
      <div>
        <main className="text-gray-900">
          <section className="pt-20 md:pt-40 bg-slate-400">
            <div className="container mx-auto px-8 lg:flex">
              <div className="text-center lg:text-left lg:w-1/2">
                ...
                <p className="text-xl lg:text-2xl mt-6 font-light">
                  A website to view the crypto currency live rates...
                </p>
                <p className="mt-8 md:mt-12">
                  <Link to = "/login"> 
                    <button
                      type="button"
                      className=" py-4 px-12 bg-yellow-200 hover:bg-teal-600 rounded text-grey">
                      Get Started
                    </button>
                  </Link>
                </p>
                <p className="mt-4 text-gray-600">
                  Start using your money to earn own.
                </p>
              </div>
